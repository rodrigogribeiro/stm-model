...
previous properties and uses function \ensuremath{\V{completions}} that generates a list of events grouped by transaction.
...
\>[B]{}\F{markability}\mathbin{::}\V{History}\to \V{Bool}{}\<[E]%
\\
\>[B]{}\F{markability}\;\V{h}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\mathrel{=}\V{and}\;[\mskip1.5mu \F{writeObservation}\;\V{h'}{}\<[E]%
\\
\>[5]{}\hsindent{6}{}\<[11]%
\>[11]{},\F{readPreservation}\;\V{h'}{}\<[E]%
\\
\>[5]{}\hsindent{6}{}\<[11]%
\>[11]{},\V{preservesOrder}\;\V{h'}\mskip1.5mu]{}\<[E]%
\\
\>[11]{}\hsindent{6}{}\<[17]%
\>[17]{}\mathkw{where}{}\<[E]%
\\
\>[17]{}\hsindent{2}{}\<[19]%
\>[19]{}\V{h'}\mathrel{=}\F{concat}\mathbin{\$}\V{completions}\;\V{h}{}\<[E]%
\ColumnHook
...
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\F{writeObservation}\mathbin{::}\V{History}\to \V{Bool}{}\<[E]%
\\
\>[B]{}\F{writeObservation}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mathrel{=}\V{\V{Map}.foldr}\;((\mathrel{\wedge})\mathbin{\circ}\V{snd})\;\V{True}\;\V{m}{}\<[E]%
\\
\>[3]{}\hsindent{2}{}\<[5]%
\>[5]{}\mathkw{where}{}\<[E]%
\\
\>[5]{}\hsindent{1}{}\<[6]%
\>[6]{}\V{m}\mathrel{=}\V{foldr}\;\V{step}\;\V{\V{Map}.empty}\;\V{h}{}\<[E]%
\\
\>[5]{}\hsindent{1}{}\<[6]%
\>[6]{}\V{step}\;(\V{IRead}\;\anonymous \;\V{v}\;\V{val})\;\V{m}{}\<[E]%
\\
\>[6]{}\hsindent{2}{}\<[8]%
\>[8]{}\mathrel{=}\mathkw{case}\;\V{\V{Map}.lookup}\;\V{v}\;\V{m}\;\mathkw{of}{}\<[E]%
\\
\>[8]{}\hsindent{5}{}\<[13]%
\>[13]{}\V{Nothing}{}\<[23]%
\>[23]{}\to \V{\V{Map}.insert}\;\V{v}\;((\V{Val}\;\C{0}),\V{True})\;\V{m}{}\<[E]%
\\
\>[8]{}\hsindent{5}{}\<[13]%
\>[13]{}\V{Just}\;(\V{val'},\V{ac})\to \V{\V{Map}.insert}\;\V{v}\;(\V{val},\V{ac}\mathrel{\wedge}\V{val}\equiv \V{val'})\;\V{m}{}\<[E]%
\\
\>[5]{}\hsindent{1}{}\<[6]%
\>[6]{}\V{step}\;(\V{IWrite}\;\anonymous \;\V{v}\;\V{val})\;\V{m}{}\<[E]%
\\
\>[6]{}\hsindent{2}{}\<[8]%
\>[8]{}\mathrel{=}\V{\V{Map}.insert}\;\V{v}\;(\V{val},\V{True})\;\V{m}{}\<[E]%
\\
\>[5]{}\hsindent{1}{}\<[6]%
\>[6]{}\V{step}\;\anonymous \;\V{ac}\mathrel{=}\V{ac}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\F{readPreservation}\mathbin{::}\V{History}\to \V{Bool}{}\<[E]%
\\
\>[B]{}\F{readPreservation}\;\V{h}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mathrel{=}\V{all}\;(\V{fst}\mathbin{\circ}\V{foldr}\;\V{step}\;(\V{True},\V{\V{Map}.empty}))\;\V{h'}{}\<[E]%
\\
\>[3]{}\hsindent{2}{}\<[5]%
\>[5]{}\mathkw{where}{}\<[E]%
\\
\>[5]{}\hsindent{2}{}\<[7]%
\>[7]{}\V{step}\;(\V{IRead}\;\anonymous \;\V{v}\;\V{val})\;(\V{ac},\V{m}){}\<[E]%
\\
\>[7]{}\hsindent{2}{}\<[9]%
\>[9]{}\mathrel{=}\mathkw{case}\;\V{\V{Map}.lookup}\;\V{v}\;\V{m}\;\mathkw{of}{}\<[E]%
\\
\>[9]{}\hsindent{5}{}\<[14]%
\>[14]{}\V{Nothing}{}\<[24]%
\>[24]{}\to (\V{ac},\V{\V{Map}.insert}\;\V{v}\;{}\<[47]%
\>[47]{}(\V{Val}\;\C{0})\;\V{m}){}\<[E]%
\\
\>[9]{}\hsindent{5}{}\<[14]%
\>[14]{}\V{Just}\;\V{val'}\to (\V{ac}\mathrel{\wedge}\V{val}\equiv \V{val'},\V{\V{Map}.insert}\;\V{v}\;\V{val'}\;\V{m}){}\<[E]%
\\
\>[5]{}\hsindent{2}{}\<[7]%
\>[7]{}\V{step}\;(\V{IWrite}\;\anonymous \;\V{v}\;\V{val})\;(\V{ac},\V{m}){}\<[E]%
\\
\>[7]{}\hsindent{2}{}\<[9]%
\>[9]{}\mathrel{=}\mathkw{case}\;\V{\V{Map}.lookup}\;\V{v}\;\V{m}\;\mathkw{of}{}\<[E]%
\\
\>[9]{}\hsindent{5}{}\<[14]%
\>[14]{}\V{Nothing}{}\<[24]%
\>[24]{}\to (\V{ac},\V{\V{Map}.insert}\;\V{v}\;\V{val}\;\V{m}){}\<[E]%
\\
\>[9]{}\hsindent{5}{}\<[14]%
\>[14]{}\V{Just}\;\V{val'}\to (\V{ac},\V{m}){}\<[E]%
\\
\>[5]{}\hsindent{2}{}\<[7]%
\>[7]{}\V{step}\;\anonymous \;\V{ac}\mathrel{=}\V{ac}{}\<[E]%
\\
\>[5]{}\hsindent{2}{}\<[7]%
\>[7]{}\V{h'}\mathrel{=}[\mskip1.5mu \V{l}\mid \V{l}\leftarrow \V{splits}\;\V{h}{}\<[E]%
\\
\>[7]{}\hsindent{9}{}\<[16]%
\>[16]{},\V{isCommit}\;(\V{last}\;\V{l})\mskip1.5mu]{}\<[E]%
\\
\>[5]{}\hsindent{2}{}\<[7]%
\>[7]{}\V{isCommit}\;(\V{ICommit}\;\anonymous )\mathrel{=}\V{True}{}\<[E]%
\\
\>[5]{}\hsindent{2}{}\<[7]%
\>[7]{}\V{isCommit}\;\anonymous \mathrel{=}\V{False}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
consider the following function that increments a value stored on a \ensuremath{\D{TVar}},
